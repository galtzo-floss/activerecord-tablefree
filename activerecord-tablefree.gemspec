...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activerecord/tablefree/version.rb", mod) }::ActiveRecord::Tablefree::Version::VERSION
  else
    require_relative "lib/activerecord/tablefree/version"
    ActiveRecord::Tablefree::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "activerecord-tablefree"
  spec.version = gem_version
  spec.authors = ["Jarl Friis", "Kenneth Kalmer", "Michal Zima", "Peter H. Boling", "behrooz shabani (everplays)", "Tobias Suchy", "Nils Öjes"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "💎 A library for implementing tablefree ActiveRecord models in Rails 5+"
  spec.description = "💎 ActiveRecord Tablefree Models provides a simple mixin for creating models that are not bound to the database. This approach is useful for taking advantage of the features of ActiveRecord such as validation, relationships, nested_attributes, etc."
  spec.homepage = "https://github.com/galtzo-floss/activerecord-tablefree"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://activerecord-tablefree.galtzo.com"
  ...
  package_metadata_files = %w[
    ...
    LICENSE.md
    README.md
    sig/activerecord/tablefree.rbs
  ...
  # Utilities
  spec.add_runtime_dependency("activerecord", ">= 5", "< 9")
  ...
  #       This gem, and its gemspec runtime dependencies, will install on Ruby down to 2.2.2.
