...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activerecord/tablefree/version.rb", mod) }::ActiveRecord::Tablefree::NoDatabase::Version::VERSION
  else
    require_relative "lib/activerecord/tablefree/version"
    ActiveRecord::Tablefree::NoDatabase::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "activerecord-tablefree"
  spec.version = gem_version
  spec.authors = ["Jarl Friis", "Kenneth Kalmer", "Michal Zima", "Peter Boling"]
